...
export default function NavBar() {
    ...
    return(
        <div className="flex flex-row justify-between m-4 text-gray-800">
            <Link href="/"><a className="font-bold text-2xl self-center mx-8">Custodi</a></Link>
            <div className="flex flex-row justify-end px-7">
            <Link href="/"><a className="font-semibold text-xl self-center mx-12">Docs</a></Link>
